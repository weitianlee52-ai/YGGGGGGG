...
IsLightTheme = true,
Scheme = {
    BackgroundColor = Color3.fromRGB(255, 240, 240),       -- 极浅粉白背景
    MainColor = Color3.fromRGB(255, 225, 230),            -- 浅腮红主色
    AccentColor = Color3.fromRGB(255, 130, 170),          -- 明亮樱花粉强调色
    OutlineColor = Color3.fromRGB(210, 185, 195),         -- 柔和灰粉边框
    FontColor = Color3.fromRGB(80, 60, 70),               -- 深灰粉字体（保证浅色下清晰）
    Font = Font.fromEnum(Enum.Font.Code),

    RedColor = Color3.fromRGB(255, 100, 130),             -- 粉红警告色
    DestructiveColor = Color3.fromRGB(200, 80, 120),      -- 深粉玫红
    DarkColor = Color3.fromRGB(100, 80, 90),              -- 浅主题下的深灰粉
    WhiteColor = Color3.fromRGB(255, 255, 255),           -- 纯白

    WindowGlow = false,                                   -- 浅色主题关闭发光
},
